...
// Render a static sun icon on the server to avoid hydration mismatches.
const SunIcon = () => (
...
// Dynamically load the client ThemeToggle (no SSR) which will replace the static icon on the client
const ThemeToggleClient = dynamic(() => import('./ThemeToggleClient'), { ssr: false });
